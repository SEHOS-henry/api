...
exports.Product_details.belongsToMany(exports.Images, { foreignKey: 'id_product_details', through: 'product_details_image' });
exports.Images.belongsToMany(exports.Product_details, { foreignKey: 'id_image', through: 'product_details_image' });
exports.Product_details.belongsToMany(exports.Sizes, { foreignKey: 'id_product_details', through: exports.Product_details_size });
exports.Sizes.belongsToMany(exports.Product_details, { foreignKey: 'id_sizes', through: exports.Product_details_size });
...
exports.Users.belongsToMany(exports.Product_details, { as: 'favs', foreignKey: 'id_user', through: 'favourite' });
exports.Product_details.belongsToMany(exports.Users, { as: 'favs', foreignKey: 'id_product_details', through: 'favourite' });
exports.Users.belongsToMany(exports.Product_details, { as: 'cart', foreignKey: 'id_user', through: exports.Cart_details });
exports.Product_details.belongsToMany(exports.Users, { as: 'cart', foreignKey: 'id_product_details', through: exports.Cart_details });
